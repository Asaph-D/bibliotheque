...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeBooks() {
        ...
        List<Livre> livres = List.of(
            new Livre(null, "Les Misérables", "978-2-07-036491-8", Genre.ROMAN, 1862, true, auteurs.get(0)),
            new Livre(null, "Notre-Dame de Paris", "978-2-07-036403-0", Genre.ROMAN, 1831, true, auteurs.get(0)),
            new Livre(null, "Voyage au Centre de la Terre", "978-2-07-044742-4", Genre.SCIENCE_FICTION, 1864, true, auteurs.get(1)),
            new Livre(null, "Vingt Mille Lieues sous les Mers", "978-2-07-036492-5", Genre.SCIENCE_FICTION, 1870, true, auteurs.get(1)),
            new Livre(null, "Meurtre sur l'Orient Express", "978-2-07-036493-2", Genre.POLICIER, 1934, true, auteurs.get(2)),
            new Livre(null, "Le Crime de l'Orient Express", "978-2-07-036494-9", Genre.POLICIER, 1934, true, auteurs.get(2)),
            new Livre(null, "Fondation", "978-0-553-29438-0", Genre.SCIENCE_FICTION, 1951, true, auteurs.get(3)),
            new Livre(null, "Les Robots", "978-0-553-29438-1", Genre.SCIENCE_FICTION, 1950, true, auteurs.get(3)),
            new Livre(null, "Théorie de la Relativité", "978-0-486-42871-1", Genre.SCIENCE, 1916, true, auteurs.get(4)),
            new Livre(null, "Sapiens", "978-2-226-24675-3", Genre.HISTOIRE, 2011, true, auteurs.get(5)),
            new Livre(null, "Homo Deus", "978-2-226-39182-8", Genre.HISTOIRE, 2015, true, auteurs.get(5)),
            new Livre(null, "Le Seigneur des Anneaux", "978-2-07-044743-1", Genre.ROMAN, 1954, true, auteurs.get(9)),
            new Livre(null, "Harry Potter à l'école des sorciers", "978-0-747-53269-9", Genre.ROMAN, 1998, true, auteurs.get(6)),
            new Livre(null, "Ça", "978-0-451-16996-4", Genre.POLICIER, 1986, true, auteurs.get(7)),
            new Livre(null, "Le Trône de Fer", "978-0-553-10359-8", Genre.ROMAN, 1996, true, auteurs.get(8)),
            new Livre(null, "Sherlock Holmes - Étude en Rouge", "978-0-141-04408-9", Genre.POLICIER, 1887, true, auteurs.get(10)),
            new Livre(null, "L'Assommoir", "978-2-07-036587-8", Genre.ROMAN, 1877, true, auteurs.get(11)),
            new Livre(null, "Le Père Goriot", "978-2-07-036588-5", Genre.ROMAN, 1835, true, auteurs.get(12)),
            new Livre(null, "Le Comte de Monte Cristo", "978-2-253-04567-0", Genre.ROMAN, 1844, true, auteurs.get(13)),
            new Livre(null, "La Comédie Divine", "978-2-07-036589-2", Genre.HISTOIRE, 1320, true, auteurs.get(14)),
            new Livre(null, "Les Trois Mousquetaires", "978-2-017-74019-5", Genre.ROMAN, 1844, true, auteurs.get(13)),
            new Livre(null, "Neuromancien", "978-0-441-56956-6", Genre.SCIENCE_FICTION, 1984, true, auteurs.get(7)),
            new Livre(null, "1984", "978-0-451-52493-5", Genre.SCIENCE_FICTION, 1949, true, auteurs.get(1)),
            new Livre(null, "Pauvre Bitos", "978-2-07-036590-8", Genre.POLICIER, 1956, true, auteurs.get(11)),
            new Livre(null, "Cinq semaines en ballon", "978-2-253-06573-9", Genre.SCIENCE_FICTION, 1863, true, auteurs.get(1)),
            new Livre(null, "Les Mystères de Paris", "978-2-07-036591-5", Genre.POLICIER, 1843, true, auteurs.get(13)),
            new Livre(null, "L'Étranger", "978-0-451-52494-2", Genre.ROMAN, 1942, true, auteurs.get(12)),
            new Livre(null, "Le Temps Retrouvé", "978-0-141-04410-2", Genre.ROMAN, 1927, true, auteurs.get(0)),
            new Livre(null, "La Bête Humaine", "978-2-07-036592-2", Genre.POLICIER, 1890, true, auteurs.get(11)),
            new Livre(null, "Les Aventures de Huckleberry Finn", "978-0-226-89457-8", Genre.ROMAN, 1884, true, auteurs.get(9))
        );
