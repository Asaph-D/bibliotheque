...
### Over-Fetching
Definition: Récupérer plus de données que nécessaire.
...
### Under-Fetching
Definition: Récupérer trop peu de données, nécessitant plusieurs requêtes.
...
- Mobile (economise 99% de bande passante!)
- Clients varies avec besoins differents
