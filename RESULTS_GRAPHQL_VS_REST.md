...
## 1. GraphQL Query 1: Éviter Over-Fetching
...
### Métriques
- Nombre de livres: 10 resultats
- Champs demandes: 3 (id, titre, disponible)
- Taille reponse: 644 bytes
- Temps requete: ~50ms

---

## 2. GraphQL Mutation: Emprunter un Livre
...
## 3. REST API: /api/livres (Without Optimization)
...
Réduction:
  GraphQL Query vs REST:     101.87x plus petit (99% réduction)
  GraphQL Mutation vs REST:  591x plus petit (99.8% réduction)
```
...
ERREUR **Over-fetching massif**
- 65KB pour 10 livres avec 3 champs demandés

ERREUR **Boucles de sérialisation**
...
- **Économie batterie**: 10x meilleure
